...
<head>
    ...
    <style>
        :root {
            ...
            --primary-gradient: linear-gradient(135deg, <?php echo e(get_theme_color()); ?> 0%, <?php echo adjustColor(get_theme_color(), -15); ?> 100%);
            --primary-light: <?php echo adjustColor(get_theme_color(), 20); ?>;
